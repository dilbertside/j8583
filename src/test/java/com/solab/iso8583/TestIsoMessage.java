...
public class TestIsoMessage {
	...
	public void testEncoding() throws Exception {
		...
		for (int i = 2; i < 128; i++) {
			...
			if (m1.hasField(i) && m2.hasField(i)) {
				...
				String val1 = m1.getObjectValue(i).toString();
				String val2 = m2.getObjectValue(i).toString();
	...
	public void testTemplating() {
        ...
        Assert.assertEquals((String)iso1.getObjectValue(3), (String)iso2.getObjectValue(3));

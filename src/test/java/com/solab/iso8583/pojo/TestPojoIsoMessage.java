...
public class TestPojoIsoMessage {
	...
	public void setUp() throws Exception {
		mf = ConfigParserPojo.createFromPojo(NetworkMgmtRequest.class, AcquirerFinancialRequest.class);
	...
	public void testNewMessageAutoStan() {
		int trace = 20;
		mf.setTraceNumberGenerator(new SimpleTraceGenerator(trace));
	    ...
	    Assert.assertEquals(Integer.valueOf(trace), iso.getObjectValue(11));
	    Assert.assertEquals(codeInformationNetwork, iso.getObjectValue(70));
